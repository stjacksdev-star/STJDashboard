...
class DashboardApiClient
{
    ...
    public function regionalSalesChart(?string $startDate = null, ?string $endDate = null): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/regional-chart', array_filter([
                'startDate' => $startDate,
                'endDate' => $endDate,
            ], fn ($value) => filled($value)));
    ...
    public function conversionChart(?string $startDate = null, ?string $endDate = null, ?string $country = null): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/conversion', array_filter([
                'startDate' => $startDate,
                'endDate' => $endDate,
                'country' => $country,
            ], fn ($value) => filled($value)));
    ...
    public function visitsChart(array $filters): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->get('/dashboard/sales/visits', array_filter([
                ...
                'previousStartDate' => $filters['previousStartDate'] ?? null,
                'previousEndDate' => $filters['previousEndDate'] ?? null,
            ], fn ($value) => filled($value)));
    ...
    public function satisfaction(): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/satisfaction');
    ...
    public function categorySales(?string $startDate = null, ?string $endDate = null): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/categories', array_filter([
                'startDate' => $startDate,
                'endDate' => $endDate,
            ], fn ($value) => filled($value)));
    ...
    public function paymentForms(): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/payment-forms');
    ...
    public function geographicSales(): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/sales/geographic');
     ...
     * @throws RequestException
     */
    public function appointmentCatalog(?string $country = null): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/appointments/catalog', array_filter([
                'country' => $country,
            ], fn ($value) => filled($value)));
    ...
    public function appointments(array $filters): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/appointments', array_filter([
                'country' => $filters['country'] ?? null,
                'store' => $filters['store'] ?? null,
            ], fn ($value) => filled($value)));
     ...
     * @throws RequestException
     */
    public function subscribers(?string $country = null): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->get('/dashboard/subscribers', array_filter([
                'country' => $country,
                'limit' => 5000,
            ], fn ($value) => filled($value)));
     ...
     * @throws RequestException
     */
    public function createSubscriber(array $data, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
     ...
     * @throws RequestException
     */
    public function updateSubscriber(int $subscriber, array $data, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post("/dashboard/subscribers/{$subscriber}", [
                ...$data,
                'actor' => $actor,
            ]);
     ...
     * @throws RequestException
     */
    public function deleteSubscriber(int $subscriber): void
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->delete("/dashboard/subscribers/{$subscriber}");
    ...
    public function shippingManagement(string $reference, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post('/dashboard/orders/shipping-management/lookup', [
                'reference' => $reference,
                'actor' => $actor,
            ]);
    ...
    public function updateShippingManagement(array $data, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post('/dashboard/orders/shipping-management', [
                ...$data,
                'actor' => $actor,
            ]);
    ...
    public function activatePromotion(int $id, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ...
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post("/dashboard/promotions/{$id}/activate", ['actor' => $actor]);
     ...
     * @throws RequestException
     */
    public function createProductCategory(array $data, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post('/dashboard/product-categories', [
                ...$data,
                'actor' => $actor,
            ]);
     ...
     * @throws RequestException
     */
    public function updateProductCategory(int $category, array $data, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->post("/dashboard/product-categories/{$category}", [
                ...$data,
                'actor' => $actor,
            ]);
     ...
     * @throws RequestException
     */
    public function deleteProductCategory(int $category): void
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->delete("/dashboard/product-categories/{$category}");
     ...
     * @throws RequestException
     */
    public function deleteClaim(int $claim): void
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->delete("/dashboard/claims/{$claim}");
     ...
     * @throws RequestException
     */
    public function cancelPushNotification(int $notification, array $actor = []): array
    {
        $response = Http::baseUrl(rtrim((string) config('stj.api.base_url'), '/'))
            ->timeout((int) config('stj.api.timeout'))
            ->withToken((string) config('stj.api.dashboard_token'))
            ->acceptJson()
            ->delete("/dashboard/push-notifications/{$notification}", [
                'actor' => $actor,
            ]);
